...
export const DEFAULT_CLINIC_CONFIG = {
    ...
    clinicName: "MOLARIZE Dental Specialty Center",
    doctorName: "Dr. Ahmed El-Sewedy",
    credentials: "BDS, MSc - Consultant Oral & Maxillofacial Surgeon",
    licenseNumber: "MOH-2026-9941",
    phone: "+20 100 123 4567",
    phoneWhatsApp: "+20 100 987 6543",
    email: "contact@molarize-dental.com",
    address: "Building 45, Makram Ebeid, Nasr City, Cairo, Egypt",
    logoUrl: "",
    signatureUrl: "",
    stampUrl: "",
    invoiceHeader: "MOLARIZE Dental Care & Advanced Implantology",
    invoiceFooter: "Thank you for choosing MOLARIZE. For dental emergency follow-ups: +20 100 987 6543",
    financial: {
        currencyCode: "EGP",
        currencySymbol: "ج.م",
        ...
        taxRegistrationNumber: "TR-894-320-11",
        paymentMethods: {
            cash: true,
            card: true,
            instapay: true,
...
export async function logAuditEvent(action, targetEntity, details = {}) {
    try {
        const logEntry = {
            ...
            userName: settingsStore.config.doctorName || "Dr. Ahmed El-Sewedy",
